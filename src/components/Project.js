  ...
  render() {
    return (
      <div>
		...
		<h4>Amount Required: Rs.{} </h4>
		<h4>Amount Collected: Rs.{} </h4>
		<Button waves='light'class="center-align">Donate<Icon right>favorite_border</Icon></Button><br/>
        
		<Tabs className='tab-demo z-depth-1'>
		<Tab title={this.state.milestones.name}>
		<h4>Title: {this.state.milestones.name}</h4>
		<h5>{this.state.milestones.description}</h5>
		<h5>Cost : Rs.{this.state.milestones.cost} </h5>
		  <Modal
